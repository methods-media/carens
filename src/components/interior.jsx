...
export const Interior = () => {
    ...
    return (
        <div ref={sectionRef} id='interior' className="w-screen bg-[#06141F] flex flex-col  items-center justify-center h-[70vh] lg:h-[100vh]">
            <motion.p
            ...
            <FloatingText2
                head1={i18n?.language == 'ar' ? `احساس` : `THE FEELING`}
                head2={i18n?.language == 'ar' ? `الرحابة` : `OF`}
                head3={i18n?.language == 'ar' ? `والراحة` : `HOMECOMING`}
                desc={t('int_desc')} />
     </div>
    )
}